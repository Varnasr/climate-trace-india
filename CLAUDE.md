# India Climate Emissions

Emissions by sector and subsector for India, drawn live from the Climate TRACE v6 API. Single page, no build step, deployed on Netlify.
...
`const API = 'https://api.climatetrace.org/v6'`. Verified live on 2026-09-22: `/country/emissions?countries=IND` returns India at rank 3 with 4.05 Gt CO2e on the 100-year basis for 2023, and 2025 data exists.
